            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="Ten" type="text" placeholder="Điền tên vào..." value="{{$user->name}}" />
                    </div>

                    <div class="form-group">
                        <label>Email</label>
                        <input class="form-control" name="email" type="email" placeholder="Nhập email..." value="{{$user->email}}" />
                    </div>
